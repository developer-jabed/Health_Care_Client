...
const ngoCategories = [
    {
        ...
        description: "Free medical camps & health awareness programs",
        count: "25+ NGOs",
    },
    {
        icon: HandHeart,
        title: "Patient Support",
        description: "Financial aid for critical and chronic patients",
        count: "15+ NGOs",
    },
    {
        icon: Users,
        title: "Community Health",
        description: "Grassroots healthcare in underserved areas",
        count: "30+ NGOs",
    },
    {
        icon: Building2,
    ...
    },
    {
        ...
        description: "Funding innovation and medical studies",
        count: "10+ Institutions",
    },
    {
        icon: Globe,
        title: "International Aid",
        description: "Global health NGOs working in Bangladesh",
        count: "12+ NGOs",
    },
];
            ...
            <div className="container mx-auto px-4 py-16">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Connecting people with NGOs providing free or subsidized healthcare
                        services.
                    </p>
                </motion.div>
                        ...
                        <CardContent className="p-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                {[
                                    {
                                        title: "Find Support",
                                        desc: "Search NGOs based on your medical needs & location",
                                    },
                                    {
                                        title: "Get Assistance",
                                        desc: "Access free or subsidized healthcare services",
                                    },
                                    {
                                        title: "Community Programs",
                                        desc: "Join health camps & awareness initiatives",
                                    },
                                    {
                                        title: "Make a Difference",
                                        desc: "Volunteer or donate to support healthcare causes",
                                    },
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                    ...
                    <Card className="border border-border bg-background/80 backdrop-blur-sm shadow-xl">
                        <CardContent className="p-10 text-center">
                            ...
                            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                                Are you a healthcare NGO? Register your organization and reach
                    ...
                    <Card className="inline-block bg-background/80 backdrop-blur-sm shadow-xl">
                        <CardContent className="p-10">
                            ...
                            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                                We are building a verified directory of healthcare NGOs to ensure
                                help reaches the right people.
                            </p>
                            <Link href="/">
